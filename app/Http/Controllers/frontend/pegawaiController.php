   ...
   public function index(Request $request)
    {
        ...
        $pegawais = Pegawai::query()
            ...
            ->orderByRaw("
                CASE
                    WHEN LOWER(employees.pangkat_golongan) LIKE '%IV%' THEN 0
                    WHEN LOWER(employees.pangkat_golongan) LIKE '%III%' THEN 1
                    WHEN LOWER(employees.pangkat_golongan) LIKE '%II%' THEN 2
                    WHEN LOWER(employees.pangkat_golongan) LIKE '%I%' THEN 3
                    ELSE 4
                END
            ")
        ...
        return view('frontend.pegawai.index', compact('pegawais', 'q', 'ketua'));
    }
}
